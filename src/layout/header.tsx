...
export function Header({ onMenuToggle }: HeaderProps) {
  ...
  const initials = email ? email.slice(0, 2).toUpperCase() : "RC";
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-40 flex h-14 items-center gap-3 border-b border-theme-subtle bg-surface/80 px-3 backdrop-blur-xl safe-area-top lg:h-16 lg:gap-4 lg:px-6"
    >
      <button
              ...
              >
                ...
                <div className="border-b border-theme-subtle px-4 py-3">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-sm font-bold text-white">
                      {initials}
                    </div>
                    <div className="min-w-0 flex-1">
